          ...
          <div className="hero-grid">
            ...
            <div className="hero-main">
              ...
              <div className="hero-socials reveal d5">
                {githubLink && (
                  <a href={githubLink.href} target="_blank" rel="noopener noreferrer" className="hero-social-link">
                ...
                {linkedinLink && (
                  <a href={linkedinLink.href} target="_blank" rel="noopener noreferrer" className="hero-social-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
