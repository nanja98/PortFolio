...
const Projects = () => {
  ...
  const data = projectsData[lang] || projectsData.fr;

  const { header, cta, projects } = data;
      ...
      <section className="projects-section">
        <div className="container">
          ...
          <div className="projects-header reveal">
            <span className="section-tag">{lang === "fr" ? "Réalisations & Portfolio" : "Portfolio & Projects"}</span>
                  ...
                  <div className="project-header">
                    ...
                    {p.featured && (
                      <span className="featured-badge">
                        {lang === "fr" ? "Ingénierie Clé" : "Key Engineering"}
                      </span>
                    )}
                  </div>
